    SELECT convert(datetime, [a11].[PublishedOnUTC]) AS 'Published Date/Time',
       convert(datetime, DATEADD(HOUR,7,[a11].[PublishedOnUTC])) AS 'Published Date/Time',
